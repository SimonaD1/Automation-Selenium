...
public class RegistrationContributorTest extends BaseUI
{
	...
	public void Registration_TC001()
	{
		...
		clickElement("becomeContributor_Button_xpath");
	...
	public void Registration_TC005()
	{
			...
			openApplicationURL("websiteURL");
			clickElement("becomeContributor_Button_xpath");
			enterText("userNameTextBox_xpath","user18888");
			enterText("emailTextBox_xpath","user8888@gmail.com");
	...
	{
		return TestDataProvider.getTestData("Registration_TestData_Worldillustrated.xlsx", "Sheet1", "RegistrationTest");
	}
